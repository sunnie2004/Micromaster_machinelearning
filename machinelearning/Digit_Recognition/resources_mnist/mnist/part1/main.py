...
def run_softmax_on_MNIST(temp_parameter=1):
    ...
    # print(compute_test_error_mod3(test_x, test_y_mod3, theta, temp_parameter))
...
def run_softmax_on_MNIST_mod3(temp_parameter=1):
    ...
    test_error__mod3 = compute_test_error_mod3(test_x, test_y_mod3, theta, temp_parameter)
    return test_error__mod3
...
print('softmax test_error_cubic=',run_softmax_on_MNIST_cubic(temp_parameter=1))